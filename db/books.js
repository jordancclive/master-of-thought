const _book_lists = {
  list_source: ["Encyclopedia Brittanica", "Open Education Database", "Bokklubben World Library", "Wikipedia", "Jordan Peterson", "Thomas Jefferson Education", "Art of Manliness"],
  list_name: ["12 Novels Considered the “Greatest Book Ever Written”", "50 Most Influential Books of All Time", "100 Best Books of All Time", "Best-Selling Books", "Great Books List", "Classics", "100 Books Every Man Should Read"],
  list_url: ["https://www.britannica.com/list/12-novels-considered-the-greatest-book-ever-written", "https://oedb.org/ilibrarian/50_books_that_changed_the_world/", "https://en.wikipedia.org/wiki/Bokklubben_World_Library", "https://en.wikipedia.org/wiki/List_of_best-selling_books", "https://www.jordanbpeterson.com/great-books/", "https://tjed.org/resources/classics/", "https://www.artofmanliness.com/articles/100-books-every-man-read/"]
}
...
module.exports = {
  ...
  getBookByNoList: () =>
    _books.reduce(function (r, a) {
      r[a.book_lists] = r[a.book_lists] || [];
      r[a.book_lists].push(a);
      return r;
    }, Object.create(null)),
  getBookSortByName: () =>
    _books.sort((a, b) => {
